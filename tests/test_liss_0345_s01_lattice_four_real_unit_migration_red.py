"""AT-TDD: LISS-0345 -- migrate S01_quantum_disaster_response/main_lattice_four
to real units (WP-0095 work unit 13).

Design decision: docs/issues/LISS-0345-s01-lattice-four-real-unit-migration.md
"""
...
def test_lattice_four_compiles_and_runs_to_a_real_terminal_measurement() -> None:
    compiled = compile_path(_LATTICE_FOUR_PATH)
