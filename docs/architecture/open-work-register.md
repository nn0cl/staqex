...
| Real-QPU readiness roadmap | **approved planning/design baseline; LISS-0456 complete; LISS-0457 Product/Tensor and LISS-0471 Measurement slices done; LISS-0472 Continuous/Open-system slice done; broader realization/provider/real-QPU work gated** | [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md); [WP-0119](../work-plans/WP-0119-real-qpu-readiness-roadmap.md); [WP-0120–0125](../work-plans/WP-0120-semantic-source-readiness.md); [LISS-0455–0472](../issues/LISS-0455-real-qpu-scope-reconciliation.md); [acceptance spec](../specs/staqex-real-qpu-readiness-acceptance.md) | Orders semantic ownership, finite artifact contracts, capability/routing, QASM conformance, provider packaging, credential safety, Job/Result integrity, human-authorized pilot, and result validation. User approved all Work Plans on 2026-08-27. Existing provider-neutral ports and AWS Braket adapter are not reimplemented. No real submission is authorized for an agent.
...
| Scientific Semantic Core / IR authority | **Binder and bounded public QASM facade canonical-projection slices complete; broader continuation is design-gated** | [LISS-0444](../issues/LISS-0444-scientific-semantic-core.md); [LISS-0445](../issues/LISS-0445-scientific-semantic-consumer-migration.md); [LISS-0446](../issues/LISS-0446-qasm-public-entry-canonical-sharing.md); [completion review 0445](../collaboration/reviews/2026-08-29-liss-0445-completion-review.md); [completion review 0446](../collaboration/reviews/2026-08-29-liss-0446-completion-review.md); [ADR 0211](adr/0211-scientific-semantic-core-and-ir-authority.md); [WP-0107](../work-plans/WP-0107-scientific-semantic-core.md); [WP-0108](../work-plans/WP-0108-scientific-semantic-consumer-migration.md); [WP-0109](../work-plans/WP-0109-qasm-public-entry-canonical-sharing.md); [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md) | Binder and local public QASM facade canonical projections are complete and reviewed. Old AST helper retirement, non-explicit `symbolic_ir` migration, remaining AST/DTO classification, and any Phase 3 facade refactor remain separately gated. Provider SDK, live QPU, and S02 numerical migration remain excluded. |
