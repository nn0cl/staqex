...
| Real-QPU readiness roadmap | **approved planning/design baseline; offline slices complete; real-device execution split into a separate human task** | [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md); [WP-0119](../work-plans/WP-0119-real-qpu-readiness-roadmap.md); [WP-0120–0126](../work-plans/WP-0120-semantic-source-readiness.md); [LISS-0455–0475](../issues/LISS-0455-real-qpu-scope-reconciliation.md); [acceptance spec](../specs/staqex-real-qpu-readiness-acceptance.md) | Semantic, finite, target, QASM, provider-neutral Host, and offline pilot-preparation slices are complete. Actual credentials, device execution, network submission, and raw-result handoff are isolated in WP-0126/LISS-0475 and require human operation. No real submission is authorized for an agent.
...
| Scientific Semantic Core / IR authority | **bounded canonical projections complete; consumer-wide continuation in progress** | [LISS-0444](../issues/LISS-0444-scientific-semantic-core.md); [LISS-0445](../issues/LISS-0445-scientific-semantic-consumer-migration.md); [LISS-0446](../issues/LISS-0446-qasm-public-entry-canonical-sharing.md); [LISS-0476](../issues/LISS-0476-symbolic-ir-consumer-migration.md); [LISS-0477](../issues/LISS-0477-ast-dto-authority-retirement.md); [ADR 0211](adr/0211-scientific-semantic-core-and-ir-authority.md); [WP-0107](../work-plans/WP-0107-scientific-semantic-core.md) | LISS-0476 and the bounded QASM slice of LISS-0477 are complete through Phase 3. Remaining evaluator, Equation/Physics DTO, H1, and Algorithm Plan authority retirement remains separate work. Provider SDK, live QPU, and S02 numerical migration remain excluded. |
...
| Classical/quantum meaning preservation | **bounded Coin/when/interfer/phase/branch semantic slices complete; finite projection remains deferred** | [LISS-0450](../issues/LISS-0450-semantic-ir-meaning-preservation.md); [LISS-0478](../issues/LISS-0478-interfer-phase-branch-meaning.md); [WP-0113](../work-plans/WP-0113-semantic-ir-meaning-preservation.md) | LISS-0478 is complete through Phase 3 for source-derived meaning, branch/control identity, provenance, and fail-closed unsupported finite projection. QPU synthesis and numerical approximation remain excluded. |
