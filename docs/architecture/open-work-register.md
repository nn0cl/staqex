...
|---|---|---|---|
| 完成形科学Workflow / 新実測S02 | **WP-0132/LISS-0515 M0 complete; WP-0133/LISS-0516 complete; WP-0134/LISS-0517 D01 complete; WP-0135/LISS-0518 D02 complete; WP-0136/LISS-0519 D03 complete; WP-0137/LISS-0520 Q01 complete; WP-0138/LISS-0521 W01 complete; WP-0139/LISS-0522 complete; WP-0140/LISS-0523 X01 complete; WP-0150/LISS-0533 R01 complete; WP-0151/LISS-0534 E01 complete; WP-0158/LISS-0541 complete; next: WP-0141/LISS-0524 Phase 0** | [WP-0131](../work-plans/WP-0131-scientific-workflow-program.md); [LISS-0514](../issues/LISS-0514-scientific-workflow-program.md); [ADR 0217](adr/0217-scientific-workflow-metadata-and-projection.md); [設計案](scientific-workflow-complete-design.md) | External Adapter/Metadata Graph/Domain Extension/source-derived Semantic IR/projections。全体28 records（親1＋子27、各WP/LISS pair）、S02優先、S01と連続場/天文/重力/太陽MHD/離散系を包含。D04の9つのRed受入契約、Green実装、Refactor、最終レビューを反映。D05のfixture lineage、encoding、比較・失敗境界をPhase 0で固定し、bounded provider-neutral comparison kernelを完了。Q01のbounded `.sqxa` artifact/runtime loaderとR01 bounded discrete interaction projectionは完了し、X01のoffline geosensor profileも完了。S01 rolling validation、広いconformance、provider deliveryは別途継続。 |
...
| Real-QPU readiness roadmap | **approved planning/design baseline; WP-0120 bounded semantic readiness matrix complete with broader families deferred; WP-0121 finite artifact complete; WP-0122 target-QASM complete; WP-0123 provider-neutral Host hardening complete; WP-0124 human pilot pending; WP-0125 conditional** | [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md); [WP-0119](../work-plans/WP-0119-real-qpu-readiness-roadmap.md); [WP-0120–0125](../work-plans/WP-0120-semantic-source-readiness.md); [LISS-0455–0479](../issues/LISS-0455-real-qpu-scope-reconciliation.md); [acceptance spec](../specs/staqex-real-qpu-readiness-acceptance.md) | Orders semantic ownership, finite artifact contracts, capability/routing, QASM conformance, provider packaging, credential safety, Job/Result integrity, human-authorized pilot, and result validation. User approved all Work Plans on 2026-08-27. Existing provider-neutral ports and AWS Braket adapter are not reimplemented. No real submission is authorized for an agent.

## Explicit deferred work

| Area | Current status | Tracking | Boundary / acceptance note |
|---|---|---|---|
| Explicit blackboard evolution / finite `Realize` | **Finite Realize/Suzuki target slice, LISS-0438 reconciliation, LISS-0442/WP-0105 inventory, and S02 numerical migration complete; any new numerical slice requires a fresh plan** | [LISS-0437](../issues/LISS-0437-explicit-evolution-surface.md); [ADR 0210](adr/0210-formal-limit-finite-realization-policy.md); [WP-0100](../work-plans/WP-0100-explicit-evolution-surface.md); [LISS-0438](../issues/LISS-0438-explicit-evolution-residual-reconciliation.md); [WP-0104](../work-plans/WP-0104-explicit-evolution-residual-reconciliation.md); [LISS-0442](../issues/LISS-0442-s02-corpus-migration-inventory.md); [WP-0105](../work-plans/WP-0105-s02-corpus-migration-inventory.md); [LISS-0443](../issues/LISS-0443-s02-numerical-migration.md); [WP-0106](../work-plans/WP-0106-s02-numerical-migration.md); [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md) | Direct `Limit` remains rejected; explicit `Realize`/Suzuki produces a provider-neutral finite plan; non-unitary `product` is rejected at the QPU gate boundary; budget overflow rejects before allocation. LISS-0438 reconciliation, LISS-0442/WP-0105 inventory, and LISS-0443/WP-0106 are complete. Provider SDK and live QPU submission remain separate, unapproved work. |
| Scientific Semantic Core / IR authority | **Bounded migration slices complete; further consumer-wide migration is design-gated** | [LISS-0444](../issues/LISS-0444-scientific-semantic-core.md); [LISS-0445](../issues/LISS-0445-scientific-semantic-consumer-migration.md); [LISS-0446](../issues/LISS-0446-qasm-public-entry-canonical-sharing.md); [LISS-0503](../issues/LISS-0503-qasm-unsupported-evolution-rejection.md); [ADR 0211](adr/0211-scientific-semantic-core-and-ir-authority.md); [WP-0107](../work-plans/WP-0107-scientific-semantic-core.md); [WP-0108](../work-plans/WP-0108-scientific-semantic-consumer-migration.md); [WP-0109](../work-plans/WP-0109-qasm-public-entry-canonical-sharing.md); [WP-0118](../work-plans/WP-0118-implementation-readiness-backlog.md) | Explicit evolution is fail-closed before QASM AST fallback; finite Suzuki/binder canonical projection and public QASM facade ownership are complete for their bounded slices. Any remaining AST/DTO or non-explicit `symbolic_ir` migration requires a refreshed inventory, a new bounded Issue/Spec review, separate Phase 1 approval, and bounded implementation review. Provider SDK, live QPU, and S02 numerical migration remain excluded. |
...
| Classical/quantum meaning preservation | **bounded Coin/when and interfer/phase slices complete; product/tensor follow-up is design intake** | [LISS-0450](../issues/LISS-0450-semantic-ir-meaning-preservation.md); [LISS-0478](../issues/LISS-0478-interfer-phase-branch-meaning.md); [LISS-0511](../issues/LISS-0511-product-tensor-meaning-preservation.md); [WP-0113](../work-plans/WP-0113-semantic-ir-meaning-preservation.md); [WP-0128](../work-plans/WP-0128-product-tensor-meaning-preservation.md) | PRs #557–#559 and LISS-0478 establish source-derived mixture/interference meaning preservation, provenance, canonical consumer authority, and fail-closed QPU projection. Product/tensor meaning is now separately designed but has no Phase 1 approval; continuous/open-system and measurement meaning remain separate future designs. |
