...
| Ideal expression / finite realization boundary review | **proposed / design intake** | [LISS-0449](../issues/LISS-0449-ideal-expression-realization-boundary.md); [WP-0112](../work-plans/WP-0112-ideal-expression-realization-boundary-review.md) | Revisit whether `Limit` and exact evolution are representable in the ideal semantic layer while remaining explicitly finite-realization-gated for QPU targets. |
