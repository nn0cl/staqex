...
| Dynamic QPU lane | Phase 3 reviewed; timing **complete**; mid-circuit Kernel **complete**; JobResult / reuse ADRs **Proposed**; Fake-exec Issue **proposed** | [LISS-0028](../issues/LISS-0028-dynamic-qpu-lane.md); ADR 0071; [ADR 0193](adr/0193-dynamic-qpu-timing-region-intent.md) / [LISS-0381](../issues/LISS-0381-dynamic-qpu-timing-region-intent.md); [ADR 0197](adr/0197-dynamic-mid-circuit-feed-forward.md) / [LISS-0382](../issues/LISS-0382-dynamic-mid-circuit-feed-forward.md); [ADR 0198](adr/0198-dynamic-jobresult-composition.md) (**Proposed**); [ADR 0199](adr/0199-dynamic-qubit-reuse-reset.md) (**Proposed**); [LISS-0383](../issues/LISS-0383-dynamic-fake-executor-wire.md) (Fake-exec Plan draft) | Rejection + timing + mid-circuit IR/diagnostics shipped. Next Architecture gates: Accept ADR 0198 (JobResult composition) and ADR 0199 (reuse/reset). Next Feature Plan gate: LISS-0383 Fake wire under supplied outcomes. Lane remains non-executable until LISS-0383 (or successor) is Plan-approved and completed. |
