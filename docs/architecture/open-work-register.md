...
| Area | Current status | Tracking | Boundary / acceptance note |
|---|---|---|---|
| Explicit blackboard evolution / finite `Realize` | **Finite Realize/Suzuki target slice and LISS-0438 residual reconciliation complete; broader corpus/S02 migration remains open** | [LISS-0437](../issues/LISS-0437-explicit-evolution-surface.md); [ADR 0210](adr/0210-formal-limit-finite-realization-policy.md); [WP-0100](../work-plans/WP-0100-explicit-evolution-surface.md); [LISS-0438](../issues/LISS-0438-explicit-evolution-residual-reconciliation.md); [WP-0104](../work-plans/WP-0104-explicit-evolution-residual-reconciliation.md) | Direct `Limit` remains rejected; explicit `Realize`/Suzuki produces a provider-neutral finite plan; non-unitary `product` is rejected at the QPU gate boundary; budget overflow rejects before allocation. LISS-0438 fixed-seed/benchmark reconciliation is complete. Broader S02 numerical migration, provider SDK, and live QPU submission remain separate, unapproved work. |
