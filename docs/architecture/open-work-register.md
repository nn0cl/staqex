...
|---|---|---|---|
| 完成形科学Workflow / 新実測S02 | **WP-0132/LISS-0515 M0 complete; WP-0133/LISS-0516 complete; WP-0134/LISS-0517 D01 complete; WP-0135/LISS-0518 D02 complete; WP-0136/LISS-0519 D03 complete; WP-0138/LISS-0521 Phase 0 accepted; WP-0139/LISS-0522 Phase 0 accepted** | [WP-0131](../work-plans/WP-0131-scientific-workflow-program.md); [LISS-0514](../issues/LISS-0514-scientific-workflow-program.md); [ADR 0217](adr/0217-scientific-workflow-metadata-and-projection.md); [設計案](scientific-workflow-complete-design.md) | External Adapter/Metadata Graph/Domain Extension/source-derived Semantic IR/projections。全体28 records（親1＋子27、各WP/LISS pair）、S02優先、S01と連続場/天文/重力/太陽MHD/離散系を包含。W01のPhase 0設計を確定し、Unit AのPhase 1 Red待ち。D04は依存WP-0138とWP-0151完了後にPhase 1 Red。QUBO/encodingはWP-0137/LISS-0520。 |
