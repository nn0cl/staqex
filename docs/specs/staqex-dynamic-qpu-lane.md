...
| Field | Value |
|---|---|
| Status | **Accepted rejection/capability boundary; timing + mid-circuit Kernel complete; JobResult + reuse/reset laws Accepted; LISS-0384 Plan approved (Red pending); LISS-0385/0383 Plan pending; execution still gated** |
