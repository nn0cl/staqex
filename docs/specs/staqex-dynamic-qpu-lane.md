...
| Field | Value |
|---|---|
| Status | **Accepted rejection/capability boundary; timing + mid-circuit Kernel complete; JobResult (ADR 0198) and reuse/reset (ADR 0199) laws Accepted; LISS-0383/0384/0385 Plan pending; execution still gated** |
