...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LISS-0576 | ready — Phase 1 Red reviewed | M | M | AIP-0576-001 | - | - | test/liss-0576-phase1-red |
...
- Issue: LISS-0576
- Reason it is unblocked: Phase 0 acceptance, Phase 1 Red, and test review
  approvals were granted 2026-09-24.
- Adjudicator approval needed: `LISS-0576 Phase 2 Green / Implementation 承認`.
