...
| Issue | [LISS-0528](../issues/LISS-0528-finite-element-solver-profile.md) |
...
| Acceptance | [Scientific Workflow specification](../specs/staqex-scientific-workflow-acceptance.md), N02 |
| Implementation permission | no; no Phase 1 approval |
| Current Next Issue | LISS-0528 Phase 0 acceptance/profile review only |

## Scope

Poisson一族のweak form、function/test space、mesh/element/quadrature/BCと外部Solver契約を結ぶ。

## Out of scope

FEM engine再実装、一般非線形要素、AMR。 共通除外: branch/commit/PR操作は今回禁止、provider SDK/認証/live QPUは独立WP。

## Acceptance scenarios and verification

N02のGiven/When/Thenを適用する。具体的検証: manufactured solution、patch/convergence、unit、BC不足/特異系診断。
...
strong/weak formの意味喪失、境界条件のadapter埋込み。
...
0. このWPのscopeとN02の具体fixture/期待値をreview。ADR承認とreadinessを確認。
...
- ID: AIP-WP-0145-2026-09-08-001; status: proposed.
