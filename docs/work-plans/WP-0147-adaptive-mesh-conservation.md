...
| Issue | [LISS-0530](../issues/LISS-0530-adaptive-mesh-conservation.md) |
| Depends on | [WP-0144](WP-0144-finite-difference-solver-profile.md) |
| Blocks | WP-0153, WP-0155, WP-0156 |
...
| Acceptance | [Scientific Workflow specification](../specs/staqex-scientific-workflow-acceptance.md), N04 |
| Implementation permission | no; no Phase 1 approval |
| Current Next Issue | LISS-0530 Phase 0 acceptance/profile review only |

## Scope

一つの既承認FDM field profileにrefine/coarsen/estimator/transferとmesh lineage/budgetを追加する。

## Out of scope

全SolverへのAMR実装、mesh tool再実装。 共通除外: branch/commit/PR操作は今回禁止、provider SDK/認証/live QPUは独立WP。

## Acceptance scenarios and verification

N04のGiven/When/Thenを適用する。具体的検証: global balance、coarsen/refineの正当対、max cells/levels拒否、error estimate履歴。
...
局所誤差減少と大域保存則の混同。partial結果の成功昇格。
...
0. このWPのscopeとN04の具体fixture/期待値をreview。ADR承認とreadinessを確認。
...
- ID: AIP-WP-0147-2026-09-08-001; status: proposed.
