...
| Field | Value |
|---|---|
| Status | in progress — LISS-0552 Phase 2 Green; Phase 3 awaiting approval |
| Phase | LISS-0552 phase-2-green |
...
| LISS-0552 projection diagnostic isolation | Phase 2 Green; Phase 3 awaiting approval | L / L | AIP-0552-001 | 0551 | - | `codex/liss-0552-projection-diagnostics` |
...
- Issue: LISS-0552 Phase 3 Refactor.
- Reason: the reviewed implementation is Green; the next phase may only
  improve readability and remove real duplication without changing behavior.
- Approval needed next: `LISS-0552 Phase 3 Refactor 承認`.
