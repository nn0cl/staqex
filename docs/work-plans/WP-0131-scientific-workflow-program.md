...
| Current Next Issue | LISS-0515 / WP-0132, M0 acceptance review; Phase 1は未承認 |
| Review | [same-context review packet](../collaboration/reviews/2026-09-08-scientific-workflow-design-review.md) |
...
- Task routing: Sora役で設計修正、same_context review。Solは受付/分割、Lunaは承認された1WP/1phase。具体model overrideなし。
...
5. **天文・物理**: 0142、0143 -> 0145 -> 0148 -> 0154、0157。
...
| [WP-0148](WP-0148-physical-experiment-gravity-profile.md) / [LISS-0531](../issues/LISS-0531-physical-experiment-gravity-profile.md) | 校正付き物理実験とNewton重力 | P01 | WP-0142, WP-0145 | proposed |
...
| WP-0118/0119 approved planning baseline | 補完 | 実機readiness中心の計画に本科学Workflow programへの案内を追加、以前のscope承認は新WPへ継承しない |
...
| Architecture | 未承認 | ADR 0217のmetadata/IR権威、binding、profile、explicit projection、Workflow/approval境界 |
...
**次の最小パッケージ M0:** ADR 0217-A（Metadataと非実行権威境界だけ）のArchitecture審査と、
WP-0132/LISS-0515のG01/G02/G03受入仕様審査。Graph記録validationだけ、6小fixture、
...
- ID: AIP-WP-0131-2026-09-08-001; status: proposed; author: Sora role / Codex desktop.
- Model/reasoning: N/A — role指定であり構成表示値は取得していない。date: 2026-09-08.
- Size: XL; route: host design/same_context review、Lunaへはchild WPの各phaseを別指定。
...
- Revises: none。WP-0093/0118/0119を補完する新program、既存見積の書換えなし。
