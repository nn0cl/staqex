...
| Issue | [LISS-0532](../issues/LISS-0532-linear-fluid-mhd-profile.md) |
| Depends on | [WP-0146](WP-0146-spectral-solver-profile.md) |
...
| Acceptance | [Scientific Workflow specification](../specs/staqex-scientific-workflow-acceptance.md), P02 |
| Implementation permission | no; no Phase 1 approval |
| Current Next Issue | LISS-0532 Phase 0 acceptance/profile review only |

## Scope

一つのlinear advectionとMHD wave profileでmass/momentum/energy、磁場divergenceとBC/sourceを報告する。

## Out of scope

非線形乱流closure、太陽全系、外部Solver engine再実装。 共通除外: branch/commit/PR操作は今回禁止、provider SDK/認証/live QPUは独立WP。

## Acceptance scenarios and verification

P02のGiven/When/Thenを適用する。具体的検証: analytic波とmode収束、各保存残差/divergence、非対応BC拒否。
...
0. このWPのscopeとP02の具体fixture/期待値をreview。ADR承認とreadinessを確認。
...
- ID: AIP-WP-0149-2026-09-08-001; status: proposed.
