...
| Issue | [LISS-0538](../issues/LISS-0538-nonlinear-fluid-profile.md) |
| Depends on | [WP-0144](WP-0144-finite-difference-solver-profile.md); [WP-0147](WP-0147-adaptive-mesh-conservation.md); [WP-0149](WP-0149-linear-fluid-mhd-profile.md) |
...
| Acceptance | [Scientific Workflow specification](../specs/staqex-scientific-workflow-acceptance.md), P04 |
| Implementation permission | no; no Phase 1 approval |
| Current Next Issue | LISS-0538 Phase 0 acceptance/profile review only |

## Scope

一つのcompressible flow/shock benchmarkでflux、closure、IC/BC、conservation、shock/error指標を外部Solverへ接続する。

## Out of scope

CFD engine再実装、全乱流closure、無指定の粘性/状態方程式推定。 共通除外: branch/commit/PR操作は今回禁止、provider SDK/認証/live QPUは独立WP。

## Acceptance scenarios and verification

P04のGiven/When/Thenを適用する。具体的検証: 参照解/収束とmass/momentum/energy balance、不正density/BC、budget/不収束の診断。
...
離散scheme/closureの物理的選択をAdapterへ隠すこと。
...
0. このWPのscopeとP04の具体fixture/期待値をreview。ADR承認とreadinessを確認。
...
- ID: AIP-WP-0155-2026-09-08-001; status: proposed.
